...
public class MusicUtil {
	...
	/**
	 * 
	 * Scale This enum presents several common scales. Each entry is an index of
	...
	/*public static String functionToRoman(int f) { // TODO : OMG this is defined elsewhere too !
		switch(f) {
		case 1: return "I  ";
		case 2: return "II ";
		case 3: return "III";
